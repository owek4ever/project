...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('profileEmail').value = userData.email || 'admin@tt.com';
            document.getElementById('profileDepartment').value = userData.department || 'Administration';
